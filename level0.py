...
def nearest_neighbor(graph, start):
    ...
    path.append(start)  # Return to the starting node to complete the cycle
    
    return path

if __name__ == "__main__":
    # Your graph represented as a list of lists
    # Example: Graph with distances between nodes
    graph = [
    ...
    result_path = nearest_neighbor(graph, start_node)
    node_names = [f"n{i}" for i in result_path]
    output = {"path": ["r0"] + node_names + ["r0"]}
    print(output)
